//
//  RentParking3ViewController.swift
//  parkallios
//
...
class RentParking3ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let ratePerHour: [Double] = stride(from: 5.00, through: 50.00, by: 0.50).map { $0 } // Tarifas desde 4.00 hasta 50.00 incrementando en 0.50
    var selectedCochera = "Cochera3" // Cochera seleccionada
