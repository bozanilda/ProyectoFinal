//
//  RentParking2ViewController.swift
//  parkallios
//
...
class RentParking2ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let ratePerHour: [Double] = stride(from: 4.50, through: 50.00, by: 0.50).map { $0 } // Tarifas desde 4.00 hasta 50.00 incrementando en 0.50
    var selectedCochera = "Cochera2" // Cochera seleccionada
