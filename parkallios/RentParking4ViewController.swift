//
//  RentParking4ViewController.swift
//  parkallios
//
...
class RentParking4ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let ratePerHour: [Double] = stride(from: 4.00, through: 50.00, by: 0.50).map { $0 } // Tarifas desde 4.00 hasta 50.00 incrementando en 0.50
    var selectedCochera = "Cochera4" // Cochera seleccionada
