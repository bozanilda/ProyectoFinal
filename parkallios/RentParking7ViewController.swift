//
//  RentParking7ViewController.swift
//  parkallios
//
...
class RentParking7ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    // MARK: - Variables
       ...
       let ratePerHour: [Double] = stride(from: 4.80, through: 50.00, by: 0.50).map { $0 } // Tarifas dinámicas de S/4.80 a S/50.00 en incrementos de S/0.50
       var selectedCochera = "Cochera7" // Cochera seleccionada
       var databaseRef: DatabaseReference! // Referencia a Firebase Realtime Database
    ...
    func updatePriceLabel() {
        let totalCost = ratePerHour[selectedHour - 1] // Precio según hora seleccionada
